...
// Imports generated by prost from proto/game_packets.proto
...
mod tests {
    ...
    fn test_protobuf_packet_roundtrip() {
        ...
        match decoded.intent {
            Some(ClientIntent {
                intent: Some(client_intent::Intent::Move(m)),
            }) => {
    ...
    fn test_protobuf_join_and_disconnect_roundtrip() {
        ...
        match decoded_join.intent {
            Some(ClientIntent {
                intent: Some(client_intent::Intent::Join(j)),
            }) => {
        ...
        match decoded_dc.intent {
            Some(ClientIntent {
                intent: Some(client_intent::Intent::Disconnect(d)),
            }) => {
    ...
    fn test_protobuf_server_packet_world_state_roundtrip() {
                ...
                entities: vec![
                    EntityState {
                        ...
                        position: Some(Vector2 {
                            x_bits: (10.5f32 * 65536.0) as i32,
                            y_bits: (-20.0f32 * 65536.0) as i32,
                        }),
                        velocity: Some(Vector2 {
                            x_bits: (1.0f32 * 65536.0) as i32,
                            y_bits: 0,
                        }),
                    ...
                    EntityState {
                        ...
                        position: Some(Vector2 {
                            x_bits: (50.0f32 * 65536.0) as i32,
                            y_bits: (30.0f32 * 65536.0) as i32,
                        }),
                        velocity: Some(Vector2 {
                            x_bits: 0,
                            y_bits: 0,
        ...
        server_packet
            .encode(&mut buf)
            .expect("Failed to encode server packet");
